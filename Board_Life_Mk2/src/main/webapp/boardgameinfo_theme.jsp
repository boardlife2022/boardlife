...
<body>
	...
	<div class="card-grid">
	    ...
	    <a class="card" href="boardgameinfo_theme_detail.jsp">
	      <div class="card__background" style="background-image: url(img/industry.jpg)"></div>
	      <div class="card__content">
	        <p class="card__category">Category</p>
	        <h3 class="card__heading">산업/제조</h3>
	      </div>
	    </a>
	    <a class="card" href="boardgameinfo_theme_detail.jsp">
	      <div class="card__background" style="background-image: url(img/Agriculture.jpg)"></div>
	      <div class="card__content">
	        <p class="card__category">Category</p>
	        <h3 class="card__heading">농업</h3>
	      </div>
	    </a>
	    <a class="card" href="boardgameinfo_theme_detail.jsp">
	      <div class="card__background" style="background-image: url(img/Civilization.jpg)"></div>
	      <div class="card__content">
	        <p class="card__category">Category</p>
	        <h3 class="card__heading">문명</h3>
	      </div>
	    </a>
	    <a class="card" href="boardgameinfo_theme_detail.jsp">
	      <div class="card__background" style="background-image: url(img/puzzle.jpg)"></div>
	      <div class="card__content">
	        <p class="card__category">Category</p>
	        <h3 class="card__heading">퍼즐</h3>
	      </div>
	    </a>
</div><br/>
